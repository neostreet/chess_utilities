          ...
          if (bTerse) { \
            ...
            if (bRatingDiff) { \
              ...
              if (!bTime) { \
                ...
                if (is_ge_elo == -1) \
                  printf("%d (%d) %s %s\n",elo+rating_diff,rating_diff,filename,time); \
                else \
                  printf("%d %d (%d) %s %s\n",(elo + rating_diff >= is_ge_elo),elo+rating_diff,rating_diff,filename,time); \
              } \
            } \
            else { \
              if (!bTime) { \
                ...
                if (is_ge_elo == -1) \
                  printf("%d %d (%d) %s %s\n",elo,elo+rating_diff,rating_diff,filename,time); \
                else \
                  printf("%d %d %d (%d) %s %s\n",(elo + rating_diff >= is_ge_elo),elo,elo+rating_diff,rating_diff,filename,time); \
              } \
            } \
          } \
          else { \
            if (bRatingDiff) { \
              ...
              if (!bTime) { \
                ...
                if (is_ge_elo == -1) \
                  printf("%d %s %s\n",elo+rating_diff,filename,time); \
                else \
                  printf("%d %d %s %s\n",(elo + rating_diff >= is_ge_elo),elo+rating_diff,filename,time); \
              } \
            } \
            else { \
              if (!bTime) { \
                ...
                if (is_ge_elo == -1) \
                  printf("%d %d %s %s\n",elo,elo+rating_diff,filename,time); \
                else \
                  printf("%d %d %d %s %s\n",(elo + rating_diff >= is_ge_elo),elo,elo+rating_diff,filename,time); \
              } \
            } \
          }
              ...
              if (!bTime) {
                ...
                if (!bOpponentName) {
                  if (is_ge_elo == -1)
                    ...
                    printf("%d %d %s %s\n",(elo >= is_ge_elo),elo,filename,time);
                }
                else {
                  if (is_ge_elo == -1)
                    printf("%d %s %s %s\n",elo,opponent_name,filename,time);
                  else
                    printf("%d %d %s %s %s\n",(elo >= is_ge_elo),elo,opponent_name,filename,time);
                }
              }
            }
