...
#define SPECIAL_MOVE_EN_PASSANT       3
#define SPECIAL_MOVE_PROMOTION_QUEEN  4
#define SPECIAL_MOVE_PROMOTION_ROOK   5
#define SPECIAL_MOVE_PROMOTION_KNIGHT 6
#define SPECIAL_MOVE_PROMOTION_BISHOP 7
...
struct game {
  ...
  char piece_offsets[NUM_PLAYERS][NUM_PIECES_PER_PLAYER];
