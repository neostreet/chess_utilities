...
#define SPECIAL_MOVE_EN_PASSANT       1
#define SPECIAL_MOVE_PROMOTION_QUEEN  2
#define SPECIAL_MOVE_PROMOTION_ROOK   3
#define SPECIAL_MOVE_PROMOTION_KNIGHT 4
#define SPECIAL_MOVE_PROMOTION_BISHOP 5
